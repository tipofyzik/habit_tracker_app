...
2. The rule, according to which streaks reset, can be developed more properly. Namely, streaks should be reset once the period is gone. For example, we have a habit which should be accomplished annually. In my implementation the year considers between two dates (e.g., 11.02.24 and 11.02.25). But it would be better to connect it to the calendar. In other words, the application should consider 'year' (or other periods) according to the calendar (this year is between 11.02.24 and 31.12.2024). This would make the habit tracker app more accurate.
